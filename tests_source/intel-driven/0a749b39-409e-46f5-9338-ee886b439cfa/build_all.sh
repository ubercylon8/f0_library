...
# PROMPTFLUX v1 — LLM-Assisted VBScript Dropper — 4 stages
#
# CRITICAL BUILD SEQUENCE:
# 1. Build unsigned stage binaries
# 2. (No separate cleanup utility; orchestrator cleans itself up.)
...
print_header "Multi-Stage Test Build: PROMPTFLUX v1 — LLM-Assisted VBScript Dropper"
...
print_step "2/8" "No separate cleanup utility — orchestrator handles cleanup."
...
echo ""
echo "  Test UUID:        ${TEST_UUID}"
echo "  Test Name:        PROMPTFLUX v1 — LLM-Assisted VBScript Dropper"
