...
# APT34 Exchange Server Weaponization with Email-Based C2 - 4 stages
#
...
declare -a STAGES=(
    "T1505.003:stage-T1505.003"
    "T1071.003:stage-T1071.003"
    "T1556.002:stage-T1556.002"
    "T1048.003:stage-T1048.003"
)
...
print_header "Multi-Stage Build: APT34 Exchange Weaponization"
