...
# Agrius Multi-Wiper Deployment Against Banking Infrastructure -- 5 stages
#
...
declare -a STAGES=(
    ...
    "T1562.001:stage-T1562.001"
    "T1485:stage-T1485"
    "T1070.001:stage-T1070.001"
)
...
print_header "Multi-Stage Test Build: Agrius Multi-Wiper"
...
echo ""
print_success "Multi-stage Agrius wiper test ready for deployment!"
