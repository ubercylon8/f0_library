...
func main() {
	...
	metadata := TestMetadata{
		...
		Score:         7.3,    // v2.1 — Realism 4.7/7.0 (API 1.7/2.5, Identifier 1.2/1.5, Telemetry Signal Quality 1.3/2.0 capped pending lab run, Execution-Context 0.5/1.0) + Structure 2.6/3.0 (Schema 1.0/1.0, Docs 1.0/1.0, Logging 0.25/0.5, Op Hygiene 0.35/0.5). Not yet lab-detonated. See info.md Score Breakdown.
