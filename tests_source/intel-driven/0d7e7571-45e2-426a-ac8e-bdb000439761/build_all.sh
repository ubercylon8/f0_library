...
# 4. Verify signatures
# 5. Compress signed binaries with gzip
...
print_header "Multi-Stage Test Build: Nightmare-Eclipse RedSun Primitive Chain"
...
# Step 2: No cleanup utility for this test
print_step "2/8" "Cleanup utility (skipped — not required for this test)"

# Step 3: Sign stage binaries (BEFORE embedding)
...
# Step 5: Compress signed binaries with gzip
...
# Step 6: Build main orchestrator (embeds SIGNED+COMPRESSED stages)
...
echo ""
echo "  Test UUID:        ${TEST_UUID}"
echo "  Test Name:        Nightmare-Eclipse RedSun Primitive Chain"
