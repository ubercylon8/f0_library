...
# Identity Endpoint Posture — 5 validators
#
...
declare -a VALIDATORS=(
    "devicejoin:checks_device_join"
    "whfb:checks_whfb"
    "mdm:checks_mdm_enrollment"
    "cloudcred:checks_cloud_credential"
    "bitlocker:checks_bitlocker_escrow"
)
...
# Step 2: Sign validator binaries
