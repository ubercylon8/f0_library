...
type CheckResult struct {
	ControlID   string // Stable control ID e.g. "ITGC-AM-001"
	Name        string
	Category    string
	Description string
	Passed      bool
	...
	// ISACA ITGC framework cross-references for auditor workpaper traceability.
	// Populated by ITGC bundle validators; empty otherwise.
	CisaDomain     string                 // CISA 2024 ECO domain (e.g. "D5: Protection of Information Assets")
	CobitObjective string                 // COBIT 2019 management objective (e.g. "DSS05.04 Manage Identity and Logical Access")
	CisV8Mapping   string                 // CIS Controls v8 mapping (e.g. "CIS 5.4 Restrict Administrator Privileges")
	ManualResidual string                 // Manual auditor residual procedures (e.g. "Verify approval documentation for each admin account")
	Evidence       map[string]interface{} // Control-specific evidence per ISACA workpaper schema (e.g. {"approved_admins":[...],"found_admins":[...]})
}
