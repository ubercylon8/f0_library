...
# ISACA ITGC Windows Endpoint Validation Bundle -- 7 validators, 31 controls (Phase-2 stub: 7 representative checks)
#
...
print_header "ISACA ITGC Windows Bundle Build: ${TEST_UUID}"
...
echo "  Bundle Name:      ISACA ITGC Windows Endpoint Validation"
echo "  Validators Built: ${validator_count}"
echo "  Total Controls:   31"
...
echo ""
print_success "ISACA ITGC Windows bundle ready for deployment!"
