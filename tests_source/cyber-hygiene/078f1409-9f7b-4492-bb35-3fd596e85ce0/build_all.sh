...
# CIS Windows Endpoint Level 1 Hardening Bundle -- 7 validators, 52 controls
#
...
declare -a VALIDATORS=(
    "credpolicy:checks_credpolicy"
    "accounts:checks_accounts"
    "netauth:checks_netauth"
    "credprotect:checks_credprotect"
    "firewall:checks_firewall"
...
print_header "CIS Windows L1 Bundle Build: ${TEST_UUID}"
...
print_step "4/7" "Building orchestrator (embedding ${validator_count} signed validators)..."
...
echo "  Bundle Name:      CIS Windows Endpoint Level 1 Hardening"
echo "  Validators Built: ${validator_count}"
echo "  Total Controls:   52"
...
echo ""
print_success "CIS Windows L1 bundle ready for deployment!"
