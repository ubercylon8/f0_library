...
type TestMetadata struct {
	...
	IsacaControlIDs []string `json:"isacaControlIds,omitempty"` // ITGC-* control IDs covered (e.g., ["ITGC-AM-003"])
	CisaDomains     []string `json:"cisaDomains,omitempty"`     // CISA 2024 ECO domains
	CobitObjectives []string `json:"cobitObjectives,omitempty"` // COBIT 2019 management objectives
}
