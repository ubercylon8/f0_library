...
// Returns the raw output. Use this for queries that need custom output handling.
...
// The script should produce objects; ConvertTo-Json is appended automatically.
