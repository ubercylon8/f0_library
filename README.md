...
A comprehensive security testing framework and library for evaluating antivirus (AV) and endpoint detection and response (EDR) solutions against various threat tactics and techniques.
